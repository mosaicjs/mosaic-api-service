...
function MosaicConnectionWrapper(service, client) {
    PgConnectionWrapper.apply(this, arguments);
    this.service = service;
    this.client = client;
}
extend(MosaicConnectionWrapper.prototype, PgConnectionWrapper.prototype, {
...
extend(
        ...
        PgConnector.prototype,
        MosaicConfig.prototype,
        MosaicService.prototype,
        {
            ...
            _newWrapper : function(client) {
                return new MosaicConnectionWrapper(this, client);
            },
                ...
                action : function(options) {
                    ...
                    return that.writeTransaction(function(w) {
                        return that._checkIndex(w, options, true, function() {
                            ...
                            var index = that._getIndex(options);
                            var lang = that._getLanguage(options);
                            return w.execSql(SQL.deleteCollectionIndex({
                                collection : collection,
                                index : index,
                                lang : lang
                            })).then(function() {
            ...
            _indexExists : function(w, collection, index, lang) {
                ...
                return this._viewExists(w, collection + '_view_' + index + '_'
                        + lang);
            },
